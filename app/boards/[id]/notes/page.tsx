    ...
    <Page>
      ...
      <MainContent>
        ...
        <PageContainer>
          <PageHeader
            title={board?.title}
            description={`Manage your collection of ${notesCount} note${notesCount === 1 ? '' : 's'}. Last updated ${new Intl.DateTimeFormat('en-US', { dateStyle: 'medium' }).format(board.updatedAt)}.`}
            ...
            <div className="flex items-center gap-3">
              ...
              <NoteModalForm
                ...
                trigger={
                  <Button
                    id="new-note-button"
                    className="rounded-full px-6 gap-2 bg-primary hover:bg-primary/90 shadow-lg shadow-primary/20 transition-all"
                  >
              ...
              {notes?.length === 0 ? (
                <div className="flex flex-col items-center justify-center py-24 text-center bg-muted/30 rounded-3xl border-2 border-dashed border-muted">
                  ...
                  <p className="text-muted-foreground max-w-sm mx-auto mb-8">
                    Start capturing your thoughts and organizing your ideas
                    here.
                  </p>
                  <NoteModalForm
                    boardId={boardId}
