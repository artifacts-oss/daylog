...
export default async function PageFooterSponsor() {
        ...
        <div className="flex flex-col md:flex-row items-center justify-between gap-6 text-[12px] font-[500] uppercase text-muted-foreground/70">
          <div className="flex items-center gap-4">
            <span className="flex items-center gap-1">
              {t('madeWith')} <HeartIcon className="h-4 w-4 text-accent-red" />{' '}
              {t('by')}{' '}
              <a
          ...
          <div className="flex items-center gap-4">
            <a
              ...
              rel="noopener"
            >
              <GithubIcon className="h-4 w-4" /> {t('sourceCode')}
            </a>
            <a
              ...
              rel="noopener"
            >
              <Coffee className="h-4 w-4" /> {t('buyMeCoffee')}
            </a>
          </div>
        </div>
      </div>
